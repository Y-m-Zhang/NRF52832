...
#define ADS1292R_START_PIN  27    //需更换引脚
#define ADS1292R_PWDN_PIN  28 
#define ADS1292R_ADC_RDY_PIN  23 
#define ADS1292R_CS_PIN  22

#define ADS1292R_CS_H     nrf_gpio_pin_set(ADS1292R_CS_PIN)
#define ADS1292R_CS_L			nrf_gpio_pin_clear(ADS1292R_CS_PIN)
#define ADS1292R_PWDN_H     nrf_gpio_pin_set(ADS1292R_PWDN_PIN)
#define ADS1292R_PWDN_L			nrf_gpio_pin_clear(ADS1292R_PWDN_PIN)
#define ADS1292R_START_H		nrf_gpio_pin_set(ADS1292R_START_PIN)
#define ADS1292R_START_L		nrf_gpio_pin_clear(ADS1292R_START_PIN)
...
extern char ads1292r_data_buff[];
...
void ADS1292R_Init(void);//ADS1292R上电复位
void ADS1292R_Work(void);				//ADS1292R连续工作
void ADS1292R_Halt(void);				//ADS1292R停止工作
char* ADS1292R_ReadData(void);//读取72位的数据
